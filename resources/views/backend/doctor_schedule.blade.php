						...
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody>
                                    @for($i=1; $i<=20; $i++)
									<tr>
										<td><img width="28" height="28" src="{{ asset('assets/backend/img/user.jpg') }}" class="rounded-circle m-r-5" alt=""> Henry Daniels</td>
										<td>Cardiology</td>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="{{ route('schedule.edit', ['id'=>3]) }}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
													<a class="dropdown-item" href="{{ route('schedule.delete', ['id'=>3]) }}" data-toggle="modal" data-target="#delete_schedule"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
